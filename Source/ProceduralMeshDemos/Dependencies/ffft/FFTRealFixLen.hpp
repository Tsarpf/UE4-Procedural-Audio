...
*/
#include "Dependencies/ffft/def.h"
#include "Dependencies/ffft/FFTRealPassDirect.h"
#include "Dependencies/ffft/FFTRealPassInverse.h"
#include "Dependencies/ffft/FFTRealSelect.h"
...
{
	const double	mul = (0.5 * FFFT_PI) / TRIGO_TABLE_ARR_SIZE;
...
void	FFTRealFixLen <LL2>::build_trigo_osc ()
{
	for (int i = 0; i < NBR_TRIGO_OSC; ++i)
	{
		...
		const double	mul = (0.5 * FFFT_PI) / len;
		osc.set_step (mul);
	}
}
